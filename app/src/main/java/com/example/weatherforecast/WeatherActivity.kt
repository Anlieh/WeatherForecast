...
class WeatherActivity: AppCompatActivity() {
    ...
    private lateinit var realtimeLayout: RelativeLayout
...
//            resources.getColor(com.google.android.material.R.color.design_default_color_primary, resources.newTheme())
//        }
        swipeRefreshLayout.setColorSchemeColors(resources.getColor(com.google.android.material.R.color.design_default_color_primary))
        refreshWeather()
    ...
    private fun setViewVariables() {
        ...
        realtimeLayout = findViewById(R.id.realtimeLayout)
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        val currTempText = "${realtime.temperature.toInt()}℃"
        currentTemp.text = currTempText
        currentSky.text = getSky(realtime.skycon).info
        val currAQIText = "空气指数 ${realtime.airQuality.aqi.chn.toInt()}"
        currentAQI.text = currAQIText
        realtimeLayout.setBackgroundResource(getSky(realtime.skycon).bg)
